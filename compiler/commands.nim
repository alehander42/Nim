...
proc testCompileOption*(switch: string, info: TLineInfo): bool =
  ...
  of "graphprof": result = contains(gOptions, optGraphProf)
  of "lineprof": result = contains(gOptions, optLineProf)
...
proc processSwitch(switch, arg: string, pass: TCmdLinePass, info: TLineInfo;
  ...
  of "graphprof": processOnOffSwitch({optGraphProf}, arg, pass, info)
  of "lineprof": processOnOffSwitch({optLineProf}, arg, pass, info)
